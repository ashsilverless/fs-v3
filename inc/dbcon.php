...
function doEmail($address,$pword){
	...
	$contents .= "<p style='text-align:left;font-family: Verdana, Arial, Helvetica, sans-serif;font-size: 12px; color:#333'>Your new password is : <strong style='font-size:1.2em'>".$pword."</strong></p>\n";
